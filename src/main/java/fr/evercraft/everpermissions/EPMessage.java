...
public class EPMessage extends EMessage<EverPermissions> {
	...
	public enum EPMessages implements EnumMessage {
		...
		USER_GROUP_INFO(							"    &6&l➤  Le groupe : &7{group}"),
		USER_GROUP_INFO_EMPTY(						"    &6&l➤  Le groupe : &7Aucun"),
		USER_GROUP_INFO_TRANSIENT(					"    &6&l➤  Le groupe temporaire : &7{group}"),
		...
		USER_SUBGROUP_INFO(							"    &6&l➤  Les sous-groupes : "),
		USER_SUBGROUP_INFO_LINE(					"        &7&l●  &7{group}"),
		USER_SUBGROUP_INFO_TRANSIENT(				"    &6&l➤  Les groupes temporaires : "),
		USER_SUBGROUP_INFO_TRANSIENT_LINE(			"        &7&l●  &7{group}"),
