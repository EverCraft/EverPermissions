...
public class EPMessage extends EMessage<EverPermissions> {
	...
	public enum EPMessages implements EnumMessage {
		...
		PERMISSIONS_BROADCAST("permissionsBroadcast", ""),
		...
		PERMISSIONS_COMMANDS_USER_CLEAR("permissionsCommandsUserClear", ""),
		PERMISSIONS_COMMANDS_USER_GROUP_ADD("permissionsCommandsUserGroupAdd", ""),
		PERMISSIONS_COMMANDS_USER_GROUP_REMOVE("permissionsCommandsUserGroupRemove", ""),
		PERMISSIONS_COMMANDS_USER_GROUP_ADDSUB("permissionsCommandsUserGroupAddsub", ""),
		PERMISSIONS_COMMANDS_USER_GROUP_REMOVESUB("permissionsCommandsUserGroupRemovesub", ""),
		PERMISSIONS_COMMANDS_USER_GROUP_PROMOTE("permissionsCommandsUserGroupPromote", ""),
		PERMISSIONS_COMMANDS_USER_GROUP_DEMOTE("permissionsCommandsUserGroupDemote", ""),
		PERMISSIONS_COMMANDS_USER_GROUP_LIST("permissionsCommandsUserGroupList", ""),
		PERMISSIONS_COMMANDS_USER_PERMISSION_ADD("permissionsCommandsUserPermissionAdd", ""),
		PERMISSIONS_COMMANDS_USER_PERMISSION_REMOVE("permissionsCommandsUserPermissionRemove", ""),
		PERMISSIONS_COMMANDS_USER_PERMISSION_CHECK("permissionsCommandsUserPermissionCheck", ""),
		PERMISSIONS_COMMANDS_USER_PERMISSION_LIST("permissionsCommandsUserPermissionList", ""),
		PERMISSIONS_COMMANDS_USER_OPTION_ADD("permissionsCommandsUserOptionAdd", ""),
		PERMISSIONS_COMMANDS_USER_OPTION_REMOVE("permissionsCommandsUserOptionRemove", ""),
		PERMISSIONS_COMMANDS_USER_OPTION_CHECK("permissionsCommandsUserOptionCheck", ""),
		PERMISSIONS_COMMANDS_USER_OPTION_LIST("permissionsCommandsUserOptionList", ""),
		PERMISSIONS_COMMANDS_GROUP_ADD("permissionsCommandsGroupAdd", ""),
		PERMISSIONS_COMMANDS_GROUP_REMOVE("permissionsCommandsGroupRemove", ""),
		PERMISSIONS_COMMANDS_GROUP_DEFAULT("permissionsCommandsGroupDefault", ""),
		PERMISSIONS_COMMANDS_GROUP_LIST("permissionsCommandsGroupList", ""),
		PERMISSIONS_COMMANDS_GROUP_INHERITANCE_ADD("permissionsCommandsGroupInheritanceAdd", ""),
		PERMISSIONS_COMMANDS_GROUP_INHERITANCE_REMOVE("permissionsCommandsGroupInheritanceRemove", ""),
		PERMISSIONS_COMMANDS_GROUP_INHERITANCE_LIST("permissionsCommandsGroupInheritanceList", ""),
		PERMISSIONS_COMMANDS_GROUP_PERMISSION_ADD("permissionsCommandsGroupPermissionAdd", ""),
		PERMISSIONS_COMMANDS_GROUP_PERMISSION_REMOVE("permissionsCommandsGroupPermissionRemove", ""),
		PERMISSIONS_COMMANDS_GROUP_PERMISSION_CHECK("permissionsCommandsGroupPermissionCheck", ""),
		PERMISSIONS_COMMANDS_GROUP_PERMISSION_LIST("permissionsCommandsGroupPermissionList", ""),
		PERMISSIONS_COMMANDS_GROUP_OPTION_ADD("permissionsCommandsGroupOptionAdd", ""),
		PERMISSIONS_COMMANDS_GROUP_OPTION_REMOVE("permissionsCommandsGroupOptionRemove", ""),
		PERMISSIONS_COMMANDS_GROUP_OPTION_CHECK("permissionsCommandsGroupOptionCheck", ""),
		PERMISSIONS_COMMANDS_GROUP_OPTION_LIST("permissionsCommandsGroupOptionList", ""),
		PERMISSIONS_COMMANDS_OTHER_GROUP_ADD("permissionsCommandsOtherGroupAdd", ""),
		PERMISSIONS_COMMANDS_OTHER_GROUP_REMOVE("permissionsCommandsOtherGroupRemove", ""),
		PERMISSIONS_COMMANDS_OTHER_GROUP_ADDSUB("permissionsCommandsOtherGroupAddsub", ""),
		PERMISSIONS_COMMANDS_OTHER_GROUP_REMOVESUB("permissionsCommandsOtherGroupRemovesub", ""),
		PERMISSIONS_COMMANDS_OTHER_GROUP_PROMOTE("permissionsCommandsOtherGroupPromote", ""),
		PERMISSIONS_COMMANDS_OTHER_GROUP_DEMOTE("permissionsCommandsOtherGroupDemote", ""),
		PERMISSIONS_COMMANDS_OTHER_GROUP_LIST("permissionsCommandsOtherGroupList", ""),
		PERMISSIONS_COMMANDS_OTHER_PERMISSION_ADD("permissionsCommandsPermissionAdd", ""),
		PERMISSIONS_COMMANDS_OTHER_PERMISSION_REMOVE("permissionsCommandsPermissionRemove", ""),
		PERMISSIONS_COMMANDS_OTHER_PERMISSION_CHECK("permissionsCommandsPermissionCheck", ""),
		PERMISSIONS_COMMANDS_OTHER_PERMISSION_LIST("permissionsCommandsPermissionList", ""),
		PERMISSIONS_COMMANDS_OTHER_OPTION_ADD("permissionsCommandsOtherOptionAdd", ""),
		PERMISSIONS_COMMANDS_OTHER_OPTION_REMOVE("permissionsCommandsOtherOptionRemove", ""),
		PERMISSIONS_COMMANDS_OTHER_OPTION_CHECK("permissionsCommandsOtherOptionCheck", ""),
		PERMISSIONS_COMMANDS_OTHER_OPTION_LIST("permissionsCommandsOtherOptionList", "");
