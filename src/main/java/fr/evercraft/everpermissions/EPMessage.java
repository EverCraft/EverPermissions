...
public class EPMessage extends EMessage<EverPermissions> {
	...
	public enum EPMessages implements EnumMessage {
		...
		USER_OPTION_ADD_ERROR(						"&cErreur : &6{player} &cpossède déjà l'option '&6{option}&c' avec la valeur '&6{value}&c' dans les mondes de type &6{type}&c."),
		...
		// Collection :
		COLLECTION_DESCRIPTION(							"Gestion des subjects"),
		...
		COLLECTION_CLEAR_DESCRIPTION(					"Supprime un subject d'une collection"),
		COLLECTION_CLEAR_CONFIRMATION(					"&7Souhaitez-vous vraiment réinitialiser toutes les données de &6{subject} &7dans la collection &6{collection} &a: {confirmation}"),
		COLLECTION_CLEAR_CONFIRMATION_BUTTON(			"&a[Confirmer]"),
		COLLECTION_CLEAR_CONFIRMATION_BUTTON_HOVER(		"&cCliquez ici pour réinitialisé toutes les données de &6{subject} &cdans la collection &6{collection}&c."),
		COLLECTION_CLEAR(								"&7Vous avez réinitialisé toutes les données du subject &6{subject} &7dans la collection &6{collection}&c."),
		COLLECTION_CLEAR_BROADCAST(						"&7Tous les données du subject &6{subject} &7dans la collection &6{collection} &7ont été réinitialisé par &6{staff}&7."),

		// Collection : Group
		COLLECTION_GROUP_DESCRIPTION(					"Gestion du groupe d'un subject"),
		
		COLLECTION_GROUP_SET_DESCRIPTION(				"Défini le groupe d'un subject"),
		COLLECTION_GROUP_SET(							"&7Le subject &6{subject} &7de la collection &6{collection} &7est désormais &6{group} &7dans les mondes de type &6{type}&7."),
		COLLECTION_GROUP_SET_BROADCAST(					"&7Le subject &6{subject} &7de la collection &6{collection} &7est désormais &6{group} &7dans les mondes de type &6{type}&7 grâce à &6{staff}&7."),
		COLLECTION_GROUP_SET_ERROR(						"&cErreur : Le subject &6{subject} &cde la collection &6{collection} &cest déjà &6{group} &cdans les mondes de type &6{type}&c."),
	
		COLLECTION_GROUP_REMOVE_DESCRIPTION(			"Supprime le groupe d'un subject"),
		COLLECTION_GROUP_REMOVE(						"&7Le subject &6{subject} &7de la collection &6{collection} &7n'est plus &6{group} &7dans les mondes de type &6{type}&7."),
		COLLECTION_GROUP_REMOVE_BROADCAST(				"&7Le subject &6{subject} &7de la collection &6{collection} &7n'est plus &6{group} &7dans les mondes de type &6{type}&7 à cause de &6{staff}&7."),
		COLLECTION_GROUP_REMOVE_ERROR(					"&cErreur : Le subject &6{subject} &7de la collection &6{collection} &cn'a pas de groupe &cdans les mondes de type &6{type}&c."),
		
		COLLECTION_GROUP_PROMOTE_DESCRIPTION(			"Promouvoit un subject"),
		COLLECTION_GROUP_PROMOTE(						"&7Le subject &6{subject} &7de la collection &6{collection} &7est désormais &6{group} &7dans les mondes de type &6{type}&7."),
		COLLECTION_GROUP_PROMOTE_BROADCAST(				"&7Le subject &6{subject} &7de la collection &6{collection} &7est désormais &6{group} &7dans les mondes de type &6{type}&7 grâce à &6{staff}&7."),
		COLLECTION_GROUP_PROMOTE_ERROR( 				"&cErreur : Le subject &6{subject} &cde la collection &6{collection} &cest déjà &6{group} &cdans les mondes de type &6{type}&c."),
		COLLECTION_GROUP_PROMOTE_ERROR_DEMOTE(			"&cErreur : Le subject &6{subject} &cde la collection &6{collection} &cpossède déjà un grade supérieur à &6{group} &cdans les mondes de type &6{type}&c."),
		
		COLLECTION_GROUP_DEMOTE_DESCRIPTION(			"Rétrograde un subject"),
		COLLECTION_GROUP_DEMOTE(						"&7Le subject &6{subject} &7de la collection &6{collection} &7est désormais &6{group} &7dans les mondes de type &6{type}&7."),
		COLLECTION_GROUP_DEMOTE_BROADCAST(				"&7Le subject &6{subject} &7de la collection &6{collection} &7est désormais &6{group} &7dans les mondes de type &6{type}&7."),
		COLLECTION_GROUP_DEMOTE_ERROR(					"&cErreur : Le subject &6{subject} &cde la collection &6{collection} &cest déjà &6{group} &cdans les mondes de type &6{type}&c."),
		COLLECTION_GROUP_DEMOTE_ERROR_PROMOTE(			"&cErreur : Le subject &6{subject} &cde la collection &6{collection} &cpossède déjà un grade inférieur à &6{group} &cdans les mondes de type &6{type}&c."),
		
		COLLECTION_GROUP_INFO_DESCRIPTION(				"Affiche le groupe d'un subject"),
		COLLECTION_GROUP_INFO_TITLE(					"&aLe groupe du subject &6{subject} &ade la collection &6{collection} &a: &6{type}"),
		
		// Collection : SubGroup
		COLLECTION_SUBGROUP_DESCRIPTION(				"Gestion des sous-groupes d'un subject"),
		
		COLLECTION_SUBGROUP_ADD_DESCRIPTION(			"Ajoute un sous-groupe à un subject",
														"Add a group to a player's subgroup list"),
		COLLECTION_SUBGROUP_ADD(						"&7Le subject &6{subject} &7de la collection &6{collection} &7possède désormais les droits &6{group} &7dans les mondes de type &6{type}&7."),
		COLLECTION_SUBGROUP_ADD_BROADCAST(				"&7Le subject &6{subject} &7de la collection &6{collection} 7possède désormais les droits &6{group} &7dans les mondes de type &6{type}&7 à cause de &6{staff}&7."),
		COLLECTION_SUBGROUP_ADD_ERROR(					"&cErreur : Le subject &6{subject} &cde la collection &6{collection} &cpossède déjà les droits &6{group} &cdans les mondes de type &6{type}&c."),
		
		COLLECTION_SUBGROUP_REMOVE_DESCRIPTION(			"Supprime un sous-groupe à un subject",
														"Remove a group from a player's subgroup list"),
		COLLECTION_SUBGROUP_REMOVE(						"&7Le subject &6{subject} &7de la collection &6{collection} &7ne possède plus les droits &6{group} &7dans les mondes de type &6{type}&7."),
		COLLECTION_SUBGROUP_REMOVE_BROADCAST(			"&7Le subject &6{subject} &7de la collection &6{collection} &7ne possède plus les droits &6{group} &7dans les mondes de type &6{type}&7 à cause de &6{staff}&7."),
		COLLECTION_SUBGROUP_REMOVE_ERROR(				"&cErreur : Le subject &6{subject} &cde la collection &6{collection} &cne possède pas les droits &6{group} &cdans les mondes de type &6{type}&c."),
		
		COLLECTION_SUBGROUP_INFO_DESCRIPTION(			"Affiche la liste des sous-groupes d'un joueur"),
		COLLECTION_SUBGROUP_INFO_TITLE(					"&aLes sous-groupes du subject &6{subject} &ade la collection &6{collection} &a: &6{type}"),
		
		// Collection : Permission
		COLLECTION_PERMISSION_DESCRIPTION(				"Gestion des permissions d'un subject"),
		
		COLLECTION_PERMISSION_ADD_DESCRIPTION(			"Ajoute une permission à un subject"),
		COLLECTION_PERMISSION_ADD_TRUE(					"&7Le subject &6{subject} &7de la collection &6{collection} &7possède désormais la permission '&6{permission}&7' dans les mondes de type &6{type}&7."),
		COLLECTION_PERMISSION_ADD_TRUE_BROADCAST(		"&7Le subject &6{subject} &7de la collection &6{collection} &7possède désormais la permission '&6{permission}&7' dans les mondes de type &6{type}&7 grâce à &6{staff}&7."),
		COLLECTION_PERMISSION_ADD_TRUE_ERROR(			"&cErreur : Le subject &6{subject} &cde la collection &6{collection} &cpossède déjà la permissions '&6{permission}&c' dans les mondes de type &6{type}&c."),
		COLLECTION_PERMISSION_ADD_FALSE(				"&7Le subject &6{subject} &7de la collection &6{collection} &7ne possède plus la permission '&6{permission}&7' dans les mondes de type &6{type}&7."),
		COLLECTION_PERMISSION_ADD_FALSE_BROADCAST(		"&7Le subject &6{subject} &7de la collection &6{collection} &7ne possède plus la permission '&6{permission}&7' dans les mondes de type &6{type}&7 grâce à &6{staff}&7."),
		COLLECTION_PERMISSION_ADD_FALSE_ERROR(			"&cErreur : Le subject &6{subject} &cde la collection &6{collection} &cne possède pas la permission '&6{permission}&c' dans les mondes de type &6{type}&c."),
		
		COLLECTION_PERMISSION_REMOVE_DESCRIPTION(		"Retire une permission à un subject"),
		COLLECTION_PERMISSION_REMOVE(					"&7Le subject &6{subject} &7de la collection &6{collection} &7ne possède plus la permission '&6{permission}&7' dans les mondes de type &6{type}&7."),
		COLLECTION_PERMISSION_REMOVE_BROADCAST(			"&7Le subject &6{subject} &7de la collection &6{collection} &7ne possède plus la permission '&6{permission}&7' dans les mondes de type &6{type}&7 grâce à &6{staff}&7."),
		COLLECTION_PERMISSION_REMOVE_ERROR(				"&cErreur : Le subject &6{subject} &cde la collection &6{collection} &cne possède pas la permission '&6{permission}&c' dans les mondes de type &6{type}&c."),
		
		COLLECTION_PERMISSION_CHECK_DESCRIPTION(		"Vérifie si un subject a une permission"),
		COLLECTION_PERMISSION_CHECK_TRUE(				"&7Le subject &6{subject} &7de la collection &6{collection} &7possède la permission '&6{permission}&7' dans les mondes de type &6{type}&7."),
		COLLECTION_PERMISSION_CHECK_FALSE(				"&7Le subject &6{subject} &7de la collection &6{collection} &7ne possède pas la permission '&6{permission}&7' dans les mondes de type &6{type}&7."),
		COLLECTION_PERMISSION_CHECK_UNDEFINED(			"&7Le subject &6{subject} &7de la collection &6{collection} &7ne possède pas la permission '&6{permission}&7' dans les mondes de type &6{type}&7."),
		
		COLLECTION_PERMISSION_INFO_DESCRIPTION(			"Affiche la liste des permissions d'un subject"),
		COLLECTION_PERMISSION_INFO_TITLE(				"&aLes permissions du subject &6{subject} &ade la collection &6{collection} &a: &6{type}"),
		
		// Collection : Option
		COLLECTION_OPTION_DESCRIPTION(					"Gestion des options d'un subject"),
		
		COLLECTION_OPTION_ADD_DESCRIPTION(				"Ajoute ou remplace une option à un subject"),
		COLLECTION_OPTION_ADD(							"&7Le subject &6{subject} &7de la collection &6{collection} &7possède désormais l'option '&6{option}&7' avec la valeur '&6{value}&7' dans les mondes de type &6{type}&7."),
		COLLECTION_OPTION_ADD_ERROR(					"&cErreur : Le subject &6{subject} &cde la collection &6{collection} &cpossède déjà l'option '&6{option}&c' avec la valeur '&6{value}&c' dans les mondes de type &6{type}&c."),
		
		COLLECTION_OPTION_REMOVE_DESCRIPTION(			"Supprime une option à un subject"),
		COLLECTION_OPTION_REMOVE(						"&7Le subject &6{subject} &7de la collection &6{collection} &7ne possède plus l'option '&6{option}&7' dans les mondes de type &6{type}&7."),
		COLLECTION_OPTION_REMOVE_ERROR(					"&cErreur : Le subject &6{subject} &cde la collection &6{collection} &cne possède pas l'option '&6{option}&c' dans les mondes de type &6{type}&c."),
		
		COLLECTION_OPTION_CHECK_DESCRIPTION(			"Vérifie si un subject a une option"),
		COLLECTION_OPTION_CHECK_DEFINED(				"&7Le subject &6{subject} &7de la collection &6{collection} &7possède l'option '&6{option}&7' avec la valeur '&6{value}&7' dans les mondes de type &6{type}&7."),
		COLLECTION_OPTION_CHECK_UNDEFINED(				"&7Le subject &6{subject} &7de la collection &6{collection} &7ne possède pas l'option '&6{option}&7' dans les mondes de type &6{type}&7."),
		
		COLLECTION_OPTION_INFO_DESCRIPTION(				"Affiche la liste des options d'un subject"),
		COLLECTION_OPTION_INFO_TITLE(					"&aLes options du subject &6{subject} &ade la collection &6{collection} &a: &6{type}"),
