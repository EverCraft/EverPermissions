		...
		if(type_group.isPresent()) {
			...
			if(group == null || !group.hasWorld(type_group.get())) {
				...
				if(this.plugin.getService().getGroupSubjects().register(group_name, type_group.get())) {
					player.sendMessage(UtilsChat.of(this.plugin.getMessages().getMessage("PREFIX") + this.plugin.getMessages().getMessage("GROUP_ADD_GROUP_STAFF")
			...
			// Groupe existant
				...
				player.sendMessage(UtilsChat.of(this.plugin.getMessages().getMessage("PREFIX") + this.plugin.getMessages().getMessage("GROUP_ADD_GROUP_ERROR")
						.replaceAll("<group>", group_name)
						.replaceAll("<type>", type_group.get())));
			}
